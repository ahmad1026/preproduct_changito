        ...
        <div className="max-w-7xl mx-auto">
          <div className="w-full pt-4 flex flex-col gap-4 items-center">
            ...
            <h1 className=" text-lg md:text-2xl text-white">
              {" "}
              <span>&#8202;</span> مرجع خرید کارت های هدیه{" "}
            </h1>
          </div>
      ...
      <div className="px-8">
        <div className="w-full max-w-7xl pt-8 md:pt-0 mx-auto">
          ...
          <div className=" flex w-full flex-row flex-wrap justify-center gap-12 mt-16">
            ...
            <Link
              href="/buy/giftcard?product=mastercart"
            ...
            >
              ...
              <span className="text-xl text-white font-bold font-Vazir">
                گیفت کارت مستر کارت
              </span>
            </Link>
            <Link
              href="/buy/giftcard?product=visacart"
              className="flex flex-col gap-5 text-center"
            >
              <Button className="font-bold">
                <img
            ...
            <Link
              href="/buy/giftcard?product=americancart"
              className="flex flex-col gap-5 text-center"
            >
              <Button className="font-bold">
                <img
              ...
              <span className="text-xl text-white font-bold font-Vazir">
                گیفت کارت امریکن اکسپرس
              </span>
            </Link>
            <Link
              href="/buy/giftcard?product=arzicart"
              className="flex flex-col gap-5 text-center"
            >
              <Button className="font-bold">
                <img
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mt-16 md:mt-32 pb-8">
            <div className="border-4 border-[#E3E730] md:p-8 py-4 rounded-lg items-center flex gap-3 md:gap-11 flex-col">
              ...
              <span className="text-md md:text-xl font-bold font-Vazir text-white">
                بهترین نرخ ارز
              </span>
            </div>
            <div className="border-4 border-[#E3E730] md:p-8 py-4  rounded-lg items-center flex gap-3 md:gap-11 flex-col">
          ...
          <div className="w-full mt-8 text-center">
            ...
            <div className="w-full border-4 text-white rounded-md border-[#E3E730] mt-4 p-4 text-center">
              <div className="max-w-3xl mx-auto">
                ...
                <p className="my-8">
                  اگر می خواهید از خدمات به صورت وب سرویس استفاده کنید، می
